 ...
 */
final class Version20200105123553 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admin ADD cart INT DEFAULT NULL, CHANGE roles roles JSON NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admin DROP cart, CHANGE roles roles LONGTEXT NOT NULL COLLATE utf8mb4_bin');

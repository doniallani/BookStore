 ...
 */
final class Version20200105104338 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE subject ADD num_book INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE genre ADD num_book INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE genre DROP num_book');
        ...
        $this->addSql('ALTER TABLE subject DROP num_book');

 ...
 */
final class Version20191230225633 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE img (id INT AUTO_INCREMENT NOT NULL, donne VARCHAR(255) NOT NULL, book INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');

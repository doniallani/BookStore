 ...
 */
final class Version20200112232742 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE orde (id INT AUTO_INCREMENT NOT NULL, book INT NOT NULL, user INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE admin CHANGE roles roles JSON NOT NULL, CHANGE cart cart INT DEFAULT NULL');
        $this->addSql('ALTER TABLE book CHANGE genre genre VARCHAR(255) DEFAULT NULL, CHANGE date_edition date_edition VARCHAR(255) DEFAULT NULL, CHANGE maison_edition maison_edition VARCHAR(255) DEFAULT NULL, CHANGE etat etat VARCHAR(255) DEFAULT NULL, CHANGE nombre_page nombre_page VARCHAR(255) DEFAULT NULL, CHANGE rate rate INT DEFAULT NULL, CHANGE num_rate num_rate INT DEFAULT NULL, CHANGE img img VARCHAR(255) DEFAULT NULL');
